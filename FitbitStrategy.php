<?php
/**
 * Fitbit strategy for Opauth
 * based on https://wiki.fitbit.com/display/API/OAuth+Authentication+in+the+Fitbit+API
 *
 * More information on Opauth: http://opauth.org
 *
 * @copyright    Copyright © NEPO Systems (http://neposystems.com)
 * @link         http://opauth.org
 * @package      Opauth.FitbitStrategy
 * @license      MIT License
 */

class FitbitStrategy extends OpauthStrategy{
	...
	public function oauth2callback(){
		if (array_key_exists('code', $_GET) && !empty($_GET['code'])){
			...
			$params = array(
				...
				'code' => $code,
				'client_id' => $this->strategy['consumer_key'],
				'client_secret' => $this->strategy['consumer_secret'],
